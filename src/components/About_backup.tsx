  ...
  return (
    <section id="about" className="relative py-20 bg-gradient-to-br from-white to-blue-50 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="space-y-6">
            <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/50">
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Detail-oriented and adaptable <span className="font-semibold text-blue-600">Data Engineering professional</span> with 
                <span className="font-semibold text-purple-600"> 1.5+ years</span> of experience in the IT industry, 
                blending a solid foundation in software development principles, agile methodologies, and cloud-based data integration.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Skilled in collaborating across teams to align data solutions with business needs, 
                while maintaining high standards for <span className="font-semibold text-blue-600">data integrity</span>, 
                <span className="font-semibold text-purple-600"> operational efficiency</span>, and continuous improvement.
              </p>
            </div>
          </div>
        ...
        {/* Education Section */}
        <div className="mt-20 bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/50">
